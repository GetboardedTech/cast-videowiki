...
<template>
  ...
  <footer v-else class="the-footer flex-wrap justify-between"  :class="classes">
    ...
    <div class="flex  justify-between">
      <router-link class="text-black mr-5" to="/terms-of-use">Terms</router-link>
      <router-link class="text-black mr-5" to="/privacy-policy"> Privacy </router-link >
      ...
      <router-link class="text-black mr-5" to="/feedback"
        >Features Request
      </router-link>
