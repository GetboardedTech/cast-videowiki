...
<template>
  <div id="knowledge-base-page">
    <div class="eventsBanner w-full lg:block flex flex-wrap">
      <TheHeader />
      <div class="section flex flex-wrap w-full m-auto">
        <div class="lg:w-1/2 w-full lg:text-left text-white">
          <h1
            class="
            mb-1
            lg:text-7xl
        ...
        <vs-row>
          <template v-for="video in videoList">
            ...
            <vs-col
              ...
              :key="video.id"
              class="lg:w-1/3 md:w-1/3 sm:w-1/2 w-full"
            >
              <VideoCard
